...
class DetProdutoRetrato(BandaDANFE):
    def __init__(self):
        ...
        self.inclui_campo_centralizado_produto(nome=u'prod_unidade', conteudo=u'uom_produto_formatada', top=0*cm, left=9.04*cm, width=0.9*cm)
        self.inclui_campo_numerico_produto(nome='prod_quantidade', conteudo=u'quantidade_produto_formatada', top=0*cm, left=9.94*cm, width=1.4*cm)
        self.inclui_campo_numerico_produto(nome='vr_unitario', conteudo=u'valorunit_produto_formatada', top=0*cm, left=11.34*cm, width=2*cm)
